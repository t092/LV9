...
const levelChallenges = {
  1: { quizzes: ['l1-q1', 'l1-q2', 'l1-q3'], sort: 'l1', dragfill: null, match: null },
  2: { quizzes: ['l2-q1', 'l2-q2', 'l2-q3'], sort: 'l2', dragfill: null, match: null },
  3: { quizzes: ['l3-q1', 'l3-q2', 'l3-q3'], sort: null, dragfill: 'l3', match: null },
  4: { quizzes: ['l4-q1', 'l4-q2', 'l4-q3'], sort: null, dragfill: null, match: null },
  5: { quizzes: ['l5-q1', 'l5-q2', 'l5-q3'], sort: 'l5combined', dragfill: null, match: 'l5' },
};
...
function showLevelComplete(level, callback) {
  ...
  const levelNames = ['美國獨立', '法國大革命', '拉丁美洲獨立', '德國統一', '義大利統一'];
